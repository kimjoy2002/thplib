...
//
//----------------------------------------------------------------------------------
void SoundImplemented::StopTagVoices( ::Effekseer::SoundTag tag )
{
	for (int i = 0; i < 2; i++) {
...
//
//----------------------------------------------------------------------------------
void SoundImplemented::PauseTagVoices( ::Effekseer::SoundTag tag, bool pause )
{
	for (int i = 0; i < 2; i++) {
...
{
	const D3DVECTOR vecTop = {0.0f, 1.0f, 0.0f};
	const D3DVECTOR vecFront = {0.0f, 0.0f, 1.0f};
