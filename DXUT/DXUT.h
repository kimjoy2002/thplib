...
HRESULT DXMyMainLoop( HACCEL hAccel = NULL );
HRESULT DXMyMessageLoop( HACCEL hAccel = NULL );
HRESULT DXMyFrameLoop( DWORD dwRunRate, DWORD dwDrawRate, HACCEL hAccel = NULL );

HRESULT DXMyFrameLoop( DWORD dwRunRate, HACCEL hAccel = NULL);
HRESULT DXMyDrawLoop( DWORD dwDrawRate, HACCEL hAccel = NULL);
